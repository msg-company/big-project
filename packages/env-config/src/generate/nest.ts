...
export interface NestAuditLoggingServiceEnv {
  ...
  LOGSTASH_TCP_PORT: number;
  LOGSTASH_UDP_PORT: number;
  LOGSTASH_API_PORT: number;
  KAFKA_PORT: number;
...
export interface NestDockerEnv {
  ...
  CONSUL_DOMAIN: string;
  CONSUL_HTTP_PORT: number;
  CONSUL_DNS_PORT: number;
  DOMAIN_BASE: string;
  AUTH_DOMAIN: string;
...
const nestAuditLoggingServiceEnvSchema = z.object({
  ...
  LOGSTASH_TCP_PORT: z.string().transform(Number),
  LOGSTASH_UDP_PORT: z.string().transform(Number),
  LOGSTASH_API_PORT: z.string().transform(Number),
  KAFKA_PORT: z.string().transform(Number),
...
const nestDockerEnvSchema = z.object({
  ...
  CONSUL_VERSION: z.string(),
  CONSUL_DOMAIN: z.string(),
  CONSUL_HTTP_PORT: z.string().transform(Number),
  CONSUL_DNS_PORT: z.string().transform(Number),
...
export class NestAuditLoggingServiceEnvService {
  ...
  get<K extends keyof NestAuditLoggingServiceEnv>(key: K): NestAuditLoggingServiceEnv[K] {
    ...
    switch (key) {
      ...
      case 'LOGSTASH_PORT': return Number(processEnvValue) as unknown as NestAuditLoggingServiceEnv[K];
      case 'LOGSTASH_TCP_PORT': return Number(processEnvValue) as unknown as NestAuditLoggingServiceEnv[K];
      case 'LOGSTASH_UDP_PORT': return Number(processEnvValue) as unknown as NestAuditLoggingServiceEnv[K];
      case 'LOGSTASH_API_PORT': return Number(processEnvValue) as unknown as NestAuditLoggingServiceEnv[K];
      case 'KAFKA_PORT': return Number(processEnvValue) as unknown as NestAuditLoggingServiceEnv[K];
      case 'KAFKA_CLIENT_ID': return processEnvValue as unknown as NestAuditLoggingServiceEnv[K];
      case 'KAFKA_GROUP_ID': return processEnvValue as unknown as NestAuditLoggingServiceEnv[K];
      case 'KAFKA_TOPICS': return processEnvValue as unknown as NestAuditLoggingServiceEnv[K];
...
export class NestAuthServiceEnvService {
  ...
  get<K extends keyof NestAuthServiceEnv>(key: K): NestAuthServiceEnv[K] {
    ...
    switch (key) {
      ...
      case 'POSTGRES_HOST': return processEnvValue as unknown as NestAuthServiceEnv[K];
      case 'POSTGRES_PORT': return Number(processEnvValue) as unknown as NestAuthServiceEnv[K];
      case 'POSTGRES_USER': return processEnvValue as unknown as NestAuthServiceEnv[K];
      case 'POSTGRES_PASSWORD': return processEnvValue as unknown as NestAuthServiceEnv[K];
...
export class NestDockerEnvService {
  ...
  get<K extends keyof NestDockerEnv>(key: K): NestDockerEnv[K] {
    ...
    switch (key) {
      ...
      case 'LOGSTASH_TCP_PORT': return Number(processEnvValue) as unknown as NestDockerEnv[K];
      case 'LOGSTASH_UDP_PORT': return Number(processEnvValue) as unknown as NestDockerEnv[K];
      case 'LOGSTASH_API_PORT': return Number(processEnvValue) as unknown as NestDockerEnv[K];
      ...
      case 'CONSUL_VERSION': return processEnvValue as unknown as NestDockerEnv[K];
      case 'CONSUL_DOMAIN': return processEnvValue as unknown as NestDockerEnv[K];
      case 'CONSUL_HTTP_PORT': return Number(processEnvValue) as unknown as NestDockerEnv[K];
      case 'CONSUL_DNS_PORT': return Number(processEnvValue) as unknown as NestDockerEnv[K];
